      ...
      <Grid item xs={12} md={6} lg={4}>
        <Widget title="Notifications Types" disableWidgetMenu>
          ...
          <div className={classes.buttonsContainer}>
            ...
            <Button variant="contained" colortheme="warning" onClick={() => props.handleNotificationCall('error', 'gagal login')} className={classnames(classes.notificationCallButton)}>Error + Retry Message</Button>
